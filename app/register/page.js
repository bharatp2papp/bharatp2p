    ...
    <main className="min-h-screen bg-[#050816] text-white flex items-center justify-center p-4 overflow-hidden relative">
      ...
      <div className="w-full max-w-sm bg-white/5 border border-white/10 rounded-[28px] p-5 backdrop-blur-xl overflow-hidden relative z-10">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="w-16 h-16 rounded-[22px] bg-gradient-to-br from-[#0f172a] to-[#020617] border border-green-400/20 flex items-center justify-center shadow-[0_0_30px_rgba(34,197,94,0.20)]">
            ...
            <div className="w-11 h-11 rounded-full bg-[#020617] border border-green-400/20 flex items-center justify-center">
              ...
              <span className="text-green-400 text-lg font-black tracking-[-2px]">

                BP

              </span>

              <span className="text-yellow-300 text-lg font-black -ml-1">
        ...
        <Link href="/login">
          ...
          <button className="w-full mt-3 bg-white/5 border border-white/10 py-4 rounded-[22px] font-bold text-sm">
